...
const PROFILE_DEFINITIONS = {
  ...
  balanced_backup3: {
    ...
    rules: {
      ...
      top10_holder_limit: { enabled: true, maxPercent: 28 },
      dev_hold_limit: { enabled: true, maxPercent: 20 },
      bundle_limit: { enabled: true, maxPercent: 20 },
      volume_threshold: { enabled: true, minVol: 30 },
      listing_age_limit: { enabled: true, maxMinutes: 5 },
      ...
      new_wallet_accumulation: { enabled: true, checkFirstXBuyers: 5, maxAccumulationPercent: 30, includeBundleAsNew: true },
      first_7_buyers_hold_limit: { enabled: true, maxPercent: 25 },
      early_buyer_count_check: { enabled: true, minCount: 5 },
    },
  },
  loose_backup2: {
    ...
    rules: {
      ...
      new_wallet_accumulation: { enabled: true, checkFirstXBuyers: 5, maxAccumulationPercent: 40, includeBundleAsNew: true },
