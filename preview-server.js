  ...
  socket.on('getAnalysis', (mint) => {
    socket.emit('analysisResult', {
      ...
      clusterAnalysis: {
        ...
        freshNewWalletCount: 2,
        walletCount: 5,
      },
      earlyBuyers: [
        { address: 'Buyer1aaaabbbbccccddddeeee1111222233334444', isFreshNewWallet: false, balance: 1.5, walletAgeDays: 45, txCount: 120, sourceOfFunds: { hasCEXFunding: true }, fundingWallets: [] },
        { address: 'Buyer2aaaabbbbccccddddeeee5555666677778888', isFreshNewWallet: true, balance: 0.3, walletAgeDays: 2, txCount: 3, sourceOfFunds: { hasCEXFunding: false }, fundingWallets: ['Funder1'] },
        { address: 'Buyer3aaaabbbbccccddddeeee9999000011112222', isFreshNewWallet: true, balance: 0.25, walletAgeDays: 1, txCount: 2, sourceOfFunds: { hasCEXFunding: false }, fundingWallets: ['Funder1'] },
        { address: 'Buyer4aaaabbbbccccddddeeeeFFFFeeeeDDDDcccc', isFreshNewWallet: false, balance: 5.2, walletAgeDays: 180, txCount: 450, sourceOfFunds: { hasCEXFunding: true }, fundingWallets: [] },
        { address: 'Buyer5aaaabbbbccccddddeeeeAAAABBBBCCCCDDDD', isFreshNewWallet: false, balance: 0.8, walletAgeDays: 15, txCount: 22, sourceOfFunds: { hasCEXFunding: false }, fundingWallets: ['Funder1'] },
      ],
      globalFee: 0.85,
    });
  });
